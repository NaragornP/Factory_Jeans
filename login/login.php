      ...
      <form name="form1" method="post" action="check_login.php">   
        <div class="login-wrap">
            ...
            <label class="checkbox">
                ...
                <span class="pull-right"> <a href="forgetpass.php"> Forgot Password?</a></span>
            </label>
            <button class="btn btn-primary btn-lg btn-block" type="submit" name="Submit" ><h3>LOGIN</h3></button>
