...
$sql = "SELECT * FROM tag_paper";
$result = $conn->query($sql);
$sql2 = "SELECT * FROM equip_transection WHERE paper_id=1";
$result2 = $conn->query($sql2);
?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <title>ป้ายกระดาษ</title>
  ...
  <section id="container" class="">
      ...
      <div class="row">
        <div class="col-lg-12">
          <h3 class="page-header"><i class="fa fa-plus-square" style="color:green;"></i>ป้ายกระดาษ</h3>
          <ol class="breadcrumb">
            <li><i class="fa fa-home"></i><a href="index.html">Home</a></li>
            <li><i class="icon_tools"></i>Equipment</li>
            <li><i class="fa fa-plus-square"></i>Tag Paper</li>
          </ol>
        </div>
      </div>
                <div class="row">
                        ...
                        <section class="panel">
                          ...
                          <br><br>
                            ...
                            <div class="col-md-8 col-md-offset-2">
                              <form class="form-horizontal" name="f1" method="post" enctype="multipart/form-data" action="paper_in.php">
                      ...
                      <div class="col-xs-6">
                        <section class="panel">
                          ...
                          <br><br>
                            ...
                            <div class="row">
                            <div class="col-md-8 col-md-offset-2">
                              <form class="form-horizontal" name="f2" method="post" action="paper_out.php">
                                <div class="form-group">
                                  <label class="col-sm-3 control-label">Code</label>
                                  <div class="col-sm-9">
                                    <?php
                                                  $resultP = $conn->query("select * from tag_paper");
              ...
              <section class="panel">
                  ...
                  <div class="row">
                    <div class="col-md-10 col-md-offset-1">
                          ...
                          ?>
                                <tr>
                                  <td><? echo $row["tp_code"];?></td>
                                  <td><? echo $row["tp_fromshop"];?></td>
                                  <td><? echo $row["tp_date"];?></td>
                                  <td style="color:blue;"><? echo $row["tp_number"];?></td>
                                  <td><center><img style="width:100%;height:100%;" src="pictureJean/tagpaper/<?php echo $row["tp_picture"];?>"></center></td>
                                  <td><a onClick="javascript: return confirm('Are You sure ? Confirm Delete.');" href="delete.php? nametagpaper=7 & idtagpaper=<?php echo $row['tp_code'];?>"><button type="button" class="btn btn-danger btn-lg btn-block"><i class="fa fa-times" aria-hidden="true"></i></button></td>
                                </tr>
                          <?
                              }
                          } else {
                    ...
                    <section class="panel">
                        ...
                        <div class="row">
                          <div class="col-md-10 col-md-offset-1">
                                ...
                                ?>
                                  <a onClick="javascript: return confirm('Are You sure ? Confirm Delete.');" href="deleteall.php? idpaper=1"><button type="button" class="btn btn-danger btn-lg btn-block"><i class="fa fa-times" aria-hidden="true"></i></button></a>
                                  <br>
                                    <table class="table table-bordered" style="width:100%">
                                      <thead>
                                        <th style="width:20%">Code</th>
