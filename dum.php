...
$sql2 = "SELECT * FROM equip_transection WHERE stud_id=1";
...
<html lang="en">
  ...
  <section id="container" class="">
      ...
      <div class="row">
        <div class="col-lg-12">
          <h3 class="page-header"><i class="fa fa-plus-square" style="color:green;"></i>กระดุม</h3>
          <ol class="breadcrumb">
            <li><i class="fa fa-home"></i><a href="index.html">Home</a></li>
            <li><i class="icon_tools"></i>Equipment</li>
            <li><i class="fa fa-plus-square"></i>Studs</li>
          </ol>
        </div>
      </div>
                <div class="row">
                        ...
                        <section class="panel">
                          ...
                          <br><br>
                            ...
                            <div class="col-md-8 col-md-offset-2">
                              <form class="form-horizontal" name="f1" method="post" enctype="multipart/form-data" action="dum_in.php">
                                <div class="form-group">
                                  <label class="col-sm-3 control-label">Code</label>
                                  <div class="col-sm-9">
                                    <input type="text" name="code1" class="form-control" placeholder="รหัสกระดุม" required>
                                  </div>
                                </div>
                                <div class="form-group">
                      ...
                      <div class="col-xs-6">
                        <section class="panel">
                          ...
                          <br><br>
                            ...
                            <div class="row">
                            <div class="col-md-8 col-md-offset-2">
                              <form class="form-horizontal" name="f2" method="post" action="dum_out.php">
                                <div class="form-group">
                                  <label class="col-sm-3 control-label">Code</label>
                                  <div class="col-sm-9">
                                    <?php
                                                  $resultP = $conn->query("select * from studs");
      ...
      <div class="row">
          <div class="col-md-6">
              <section class="panel">
                  ...
                  ?>
                        <tr>
                          <td><? echo $row["st_code"];?></td>
                          <td><? echo $row["st_from"];?></td>
                          <td><? echo $row["st_date"];?></td>
                          <td style="color:blue;"><? echo $row["st_number"];?></td>
                          <td><center><img style="width:100%;height:100%;" src="pictureJean/studs/<?php echo $row["st_picture"];?>"></center></td>
                          <td><a onClick="javascript: return confirm('Are You sure ? Confirm Delete.');" href="delete.php? namedum=1 & iddum=<?php echo $row['st_code'];?>"><button type="button" class="btn btn-danger btn-lg btn-block"><i class="fa fa-times" aria-hidden="true"></i></button></td>
                        </tr>
                  <?
                      }
                  } else {
...
<!-- ---------------- END Co. l------------------ -->
          <div class="col-md-6">
              <section class="panel">
                  ...
                  ?>
                    <a onClick="javascript: return confirm('Are You sure ? Confirm Delete.');" href="deleteall.php? iddum=1"><button type="button" class="btn btn-danger btn-lg btn-block"><i class="fa fa-times" aria-hidden="true"></i></button></a>
                      <br>
                      <table class="table table-bordered" style="width:100%">
                        <thead>
                          <th style="width:20%">Code</th>
