...
$sql2 = "SELECT * FROM equip_transection WHERE dai_id=1";
...
<html lang="en">
  ...
  <section id="container" class="">
      ...
      <div class="row">
        <div class="col-lg-12">
          <h3 class="page-header"><i class="fa fa-plus-square" style="color:green;"></i>ด้าย</h3>
          <ol class="breadcrumb">
            <li><i class="fa fa-home"></i><a href="index.html">Home</a></li>
            <li><i class="icon_tools"></i>Equipment</li>
            <li><i class="fa fa-plus-square"></i>Thread</li>
          </ol>
        </div>
      </div>
                        ...
                        <section class="panel">
                          ...
                          <br><br>
                            ...
                            <div class="col-md-8 col-md-offset-2">
                              <form class="form-horizontal" name="f1" method="post" action="dai_in.php">
                                <div class="form-group">
                                  <label class="col-sm-3 control-label">Code</label>
                                  <div class="col-sm-9">
                                    <input type="text" name="code1" class="form-control" placeholder="รหัส" required>
                                  </div>
                                </div>
                                <div class="form-group">
                                  <label class="col-sm-3 control-label">Color</label>
                                  <div class="col-sm-9">
                                    <input type="text" name="color1" class="form-control" placeholder="สี" required>
                                  </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-9">
                                    <input type="number" name="number1" min="0" class="form-control" placeholder="จำนวน" required>
                                  </div>
                                </div>
                                <div class="form-group">
                      ...
                      <div class="col-xs-6">
                        <section class="panel">
                          ...
                          <br><br>
                            ...
                            <div class="row">
                            <div class="col-md-8 col-md-offset-2">
                              <form class="form-horizontal" name="f2" method="post" action="dai_out.php">
                                <div class="form-group">
                                  <label class="col-sm-3 control-label">Code</label>
                                  <div class="col-sm-9">
                                    <?php
                                                  $resultP = $conn->query("select * from dai");
                                                  ...
                                                  echo "</select>";
                                    ?> 
                                    <!-- <input type="text" name="code2" class="form-control" placeholder="รหัส" required> -->
                                  </div>
                                </div>
                               <!--  <div class="form-group">
                                  <label class="col-sm-3 control-label">Color</label>
                                  <div class="col-sm-9">
                                    <input type="text" name="color2" class="form-control" placeholder="สี" required>
                                  </div>
                                </div>
                                <div class="form-group">
                                  <label class="col-sm-3 control-label">From Shop</label>
                                  ...
                                  <label class="col-sm-3 control-label">Number</label>
                                  <div class="col-sm-9">
                                    <input type="number" name="number2" min="0" class="form-control" placeholder="จำนวน" required>
                                  </div>
                                </div>
                                <div class="form-group">
                                  <label class="col-sm-3 control-label">Date</label>
              ...
              <section class="panel">
                  ...
                  <div class="row">
                    <div class="col-md-10 col-md-offset-1">
                      ...
                      ?>
                            <tr>
                              <td><? echo $row["k_code"];?></td>
                              <td><? echo $row["k_color"];?></td>
                              <td><? echo $row["k_from"];?></td>
                              <td><? echo $row["k_date"];?></td>
                              <td style="color:blue;"><? echo $row["k_number"];?></td>
                              <td><a onClick="javascript: return confirm('Are You sure ? Confirm Delete.');" href="delete.php? namedai=2 & iddai=<?php echo $row['k_code'];?>"><button type="button" class="btn btn-danger btn-lg btn-block"><i class="fa fa-times" aria-hidden="true"></i></button></td>
                            </tr>
                      <?
                          }
                      } else {
              ...
              <section class="panel">
                  ...
                  <div class="row">
                    <div class="col-md-10 col-md-offset-1">
                        ...
                        ?>
                          <a onClick="javascript: return confirm('Are You sure ? Confirm Delete.');" href="deleteall.php? iddai=1"><button type="button" class="btn btn-danger btn-lg btn-block"><i class="fa fa-times" aria-hidden="true"></i></button></a>
                          <br>
                            <table class="table table-bordered" style="width:100%">
                              <thead>
                                <th style="width:20%">Code</th>
