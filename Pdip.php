...
$sql = "SELECT * FROM calico";
$result = $conn->query($sql);
$sql2 = "SELECT * FROM equip_transection WHERE calico_id=1";
...
<html lang="en">
  ...
  <section id="container" class="">
      ...
      <div class="row">
        <div class="col-lg-12">
          <h3 class="page-header"><i class="fa fa-plus-square" style="color:green;"></i>ผ้าดิบ</h3>
          <ol class="breadcrumb">
            <li><i class="fa fa-home"></i><a href="index.html">Home</a></li>
            <li><i class="icon_tools"></i>Equipment</li>
            <li><i class="fa fa-plus-square"></i>Calico</li>
          </ol>
        </div>
      </div>
                        ...
                        <section class="panel">
                          ...
                          <br><br>
                            ...
                            <div class="col-md-8 col-md-offset-2">
                              <form class="form-horizontal" name="f1" method="post" action="Pdip_in.php" required>
                      ...
                      <div class="col-xs-6">
                        <section class="panel">
                          ...
                          <br><br>
                            ...
                            <div class="row">
                            <div class="col-md-8 col-md-offset-2">
                              <form class="form-horizontal" name="f2" method="post" action="Pdip_out.php">
                                <div class="form-group">
                                  <label class="col-sm-3 control-label">Code</label>
                                  <div class="col-sm-9">
                                    <!-- <input type="text" name="code2" class="form-control" placeholder="รหัสผ้า" required> -->
                                    <?php
                                                  $resultP = $conn->query("select * from calico");
                      ...
                      <section class="panel">
                          ...
                          <br>
                            ...
                            <div class="col-md-10 col-md-offset-1">
                              ...
                              ?>
                                    <tr>
                                      <td><? echo $row["ca_code"];?></td>
                                      <td><? echo $row["ca_date"];?></td>
                                      <td><? echo $row["ca_from"];?></td>
                                      <!-- <td><? echo $row["ca_color"];?></td> -->
                                      <td style="color:blue;"><? echo $row["ca_yard"];?></td>
                                      <td><a onClick="javascript: return confirm('Are You sure ? Confirm Delete.');" href="delete.php? namepdip=5 & idpdip=<?php echo $row['ca_code'];?>"><button type="button" class="btn btn-danger btn-lg btn-block"><i class="fa fa-times" aria-hidden="true"></i></button></td>
                                    </tr>
                              <?
                                  }
                              } else {
                    ...
                    <section class="panel">
                        ...
                        <div class="row">
                          <div class="col-md-10 col-md-offset-1">
                              ...
                              ?>
                                <a onClick="javascript: return confirm('Are You sure ? Confirm Delete.');" href="deleteall.php? idpdip=1"><button type="button" class="btn btn-danger btn-lg btn-block"><i class="fa fa-times" aria-hidden="true"></i></button></a>
                                <br>
                                  <table class="table table-bordered" style="width:100%">
                                    <thead>
                                      <th style="width:20%">Code</th>
